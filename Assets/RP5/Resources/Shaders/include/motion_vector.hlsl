...
// using the current and previous view projection matrices and jitter offsets
float2 ComputeMotionVector(float4 position_ws, float4x4 vp, float4x4 vp_prev, float2 jitter_offset, float2 jitter_offset_prev)
{
    ...
    position_uv_prev = position_uv_prev - jitter_offset_prev;
    ...
    position_uv = position_uv - jitter_offset;
