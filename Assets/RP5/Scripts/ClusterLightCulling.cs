...
//    public class ClusterLightCulling
//    {
...
//        static int tile_x_res = 32;
//        static int tile_y_res = 32;
...
//            num_tiles_x = Utils.AlignUp(camera.pixelWidth, 32);
//            num_tiles_y = Utils.AlignUp(camera.pixelHeight, 32);
...
//            //{
//            //    float4 t_p = camera.projectionMatrix * new float4(0.0f, 0.0f, -zplanes[z], 1.0f);
//            //    zplanes[z] = t_p.z / t_p.w;

//            //}


//            float4 t_p = camera.projectionMatrix * new float4(-1.0f, -1.0f, -900.0f, 1.0f);
//            t_p /= t_p.w;
//            float4 t_p2 = camera.projectionMatrix * new float4(1.0f, 1.0f, -5.0f, 1.0f);
//            t_p2 /= t_p2.w;
//            // left to right
...
//                        float z = -1.0f + 1.0f / num_tiles_z * k * 2.0f;
//                        cluster_vertices[point_index] = new Vector3(x, y, z);
//                    }
//                }
//            }
